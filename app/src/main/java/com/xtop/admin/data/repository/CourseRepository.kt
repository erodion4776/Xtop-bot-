...
class CourseRepository {
    ...
    suspend fun updateSlide(slideId: String, updates: Map<String, String?>) {
        db.from("module_slides").update(updates) {
            filter { eq("id", slideId) }
        }
    }
